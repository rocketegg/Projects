...
def get_statistical_max(score, opponent_score):
    ...
    if (dice == six_sided):  #chance of rolling a 0, 1, 2, 3, 4, 5 and 6, #1 is 10 dice, others are 1 dice
        percentages = {1:.8333, 2:.1666, 3:.1666, 4:.1666,
                        5:.1666, 6:.1666 }
    else:  #chance of rolling a "1" when rolling 10 four-sided dice, #1 is 10 dice, rest are 1 dice
        percentages = {1:.9444, 2:.25, 3:.25, 4:.25} 
